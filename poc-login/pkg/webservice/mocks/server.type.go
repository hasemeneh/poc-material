...
import (
	...
	router "github.com/hasemeneh/poc-material/poc-login/pkg/router"
)
...
func (mr *MockWebServiceMockRecorder) GracefulStop() *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GracefulStop", reflect.TypeOf((*MockWebService)(nil).GracefulStop))
}
