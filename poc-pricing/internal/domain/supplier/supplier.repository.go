...
import (
	...
	"github.com/hasemeneh/poc-material/poc-pricing/internal/domain/supplier/cache"
	"github.com/hasemeneh/poc-material/poc-pricing/internal/domain/supplier/queries"
...
func New(o *Args) repository.Supplier {
	return &repo{
